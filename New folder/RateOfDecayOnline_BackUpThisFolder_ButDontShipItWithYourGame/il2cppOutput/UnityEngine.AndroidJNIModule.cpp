...
IL_0039:
	...
	try
	{
		...
		}
		{
			...
			L_22 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(103, L_20, L_21);
			V_8 = 0;
			V_9 = L_22;
			V_10 = 0;
			goto IL_00f2_1;
...
IL_0064_1:
		...
		}
		{
			...
			L_32 = VirtualFuncInvoker0< ParameterInfoU5BU5D_t86995AB4A1693393FE29B058CC3FD727DF0B984C* >::Invoke(16, L_31);
			V_12 = L_32;
...
IL_00b6_1:
		{
			...
			NullCheck(L_50);
			bool L_55;
			L_55 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(22, L_50, L_54);
			if (L_55)
			{
				goto IL_00d0_1;
			}

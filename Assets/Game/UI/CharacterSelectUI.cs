...
public class CharacterSelectUI : MonoBehaviour
{
    ...
    public void Play()
    {
        ...
        {
            Debug.LogError("[CharacterSelect] No NetworkManager found in scene.");
            return;
        }

        // Point Mirror at the live server and connect.
        // RodNetworkAuthenticator handles the JWT handshake.
        // RodNetworkManager.OnClientConnect() sends the class selection.
        // Mirror then loads the Online Scene ("GameWorld") for all players.
